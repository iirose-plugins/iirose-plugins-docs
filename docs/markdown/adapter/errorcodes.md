...
| `布豪！ bot.socket.readyState == 0`      | WebSocket 连接中（已不再作为错误输出）             | 连接建立期间跳过本次发送，无需处理               |
...
:::tip 获取帮助
如果遇到其他错误，请加入 QQ 群 **1059933235** 或在 [GitHub](https://github.com/iirose-plugins/koishi-plugin-adapter-iirose/issues) 提交问题。
:::
